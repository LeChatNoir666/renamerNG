...
namespace RenamerNG
{
	...
	/// </summary>
    public enum ListColumns { NewName, Size, OldName, Path, Changed, Updated, Success, Created, Modified, Accessed, Ext, ChangeFromRestorePoint, RestorePoint, MP3BitRate };
